...
documents = []
ignore_letters = ["?", ".", "!", ","]
words_path = "views/youtube/words.pkl"
model_path = "views/youtube/youtube.h5"
classes_path = "views/youtube/classes.pkl"
glove_file = "corpdata/glove/glove.6B.50d.txt"
intents = json.loads(open("views/youtube/youtube.json").read())
