...
classes = []
documents = []
words_path = "views/genre/words.pkl"
ignore_letters = ["?", ".", "!", ","]
classes_path = "views/genre/classes.pkl"
model_path = "views/genre/genre_model.h5"
...
tuner = RandomSearch(
    ...
    max_trials=60,
    executions_per_trial=40,
    directory="views/genre/hyperModel",
