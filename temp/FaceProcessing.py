...
print(
    Fore.YELLOW + Style.BRIGHT + "• Total number of samples: " + str(X_Index.shape[0])
)
print(
    Fore.YELLOW + Style.BRIGHT + "• Total number of features: " + str(X_Index.shape[1])
)
print(Fore.YELLOW + Style.BRIGHT + "• Total number of labels: " + str(Y_Index.shape[0]))
...
def Hyper_Builder(hp):
    ...
    print(Fore.CYAN + Style.BRIGHT + "• kernel_size_1: " + str(hp.get("kernel_size_1")))
